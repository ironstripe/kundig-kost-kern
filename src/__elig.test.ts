...
function run(d:any,v:any,a:any,l:any,items:any){return calculateMenuTotals({card,dishes:d,variants:v,addOns:a,links:l,items,ingredients:ing,excludedDays:[],categories:[]} as any);}
