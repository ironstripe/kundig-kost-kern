...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Interne Kalkulationsplattform des Kundelfingerhofs für Wareneinsatz und Deckungsbeitrag.",
      },
    ...
    links: [
      ...
      { rel: "alternate icon", href: "/favicon.ico?v=1", type: "image/x-icon" },
